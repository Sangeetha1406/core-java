...
<nav class="navbar navbar bg-dark" data-bs-theme="dark">
  <div class="container-fluid">
    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
     ...
     <a class="btn btn-outline-warning" href="foodItem.jsp">Foods</a>
      </form>
</nav>


<h1>This item page is hotel menu</h1>

<form action="home" method="post">
<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Name</label>
  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="enter food item name" name="name">
</div>
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" id="exampleFormControlInput1" name="price" placeholder="enter food item price">
</div>
