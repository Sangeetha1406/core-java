...
public static void main(String[] args) {
	...
	System.out.println("enter patient new addres");
	patient.setAddress(sc.next());
	...
	System.out.println("enter patients new addres");
	ap.getupdatePatientAddressByName();
	
	System.out.println("enter patients new age by name");
	ap.getPatientByAge(sc.nextInt());
	
	System.out.println("enter delete by patient name");
	//ap.deletePatientByName();
