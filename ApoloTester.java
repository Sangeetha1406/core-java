...
//	//int patientAge=sc.nextInt();
	...
	System.out.println("enter gender to search name2");
...
//	//String PatientName=sc.n--ext();
	...
	System.out.println("enter patient name to update addres");
	ap.updatePatientAddressByName(sc.next(), sc.next());
	ap.getPatient();
	
	System.out.println("enter patient name to update age");
	ap.upadtePatientAgeByName(sc.next(), sc.nextInt());
	ap.getPatient();
	
	System.out.println("enter patient name to delete");
	ap.deletePatientByName(sc.next());
